...
Vector3D Object3D::colorIncrement = Vector3D( 0.04f, 0.04f, 0.04f ); // Value with which SelectedColor is incremented / decremented.
...
Vector3D Object3D::computeNormal( Vector3D vertex1, Vector3D vertex2, Vector3D vertex3 ){
	Vector3D A, B, normal;
...
void Object3D::draw(){
	...
	glMaterialfv( GL_FRONT_AND_BACK, GL_SPECULAR,Vector4D( 0.1f, 0.1f, 0.1f, 1 ).Array() );
