...
std::string bmpLoader::loadBMP( std::string textureFilename ){
	...
	if( !input.is_open() )
		errorHandler( ERROR_CODE5, std::string( "ERROR 5: BMP file " + textureFilename + " doesn't exist." ), GetLastErrorAsString() );
