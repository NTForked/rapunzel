...
const float COLLISION_PADDING_OFFSET =
    0.10f;  // Should be between 0.00f and 0.10f.
#ifdef __CUDA_ARCH__
__device__
#endif
    const float RESTORATION_OFFSET =
        0.00f;  // Extra distance for hair restoration.
...
const std::string BLUE = "[1;34m";
const std::string GREEN = "[1;32m";
const std::string RED = "[1;31m";
const std::string STOP = "[0m";
...
//> Functions.
// static void errorHandler( int error, std::string personalizedText,
